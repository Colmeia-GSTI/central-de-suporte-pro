...
14. **RLS de segredos em `integration_settings`** — se SELECT for `is_staff`, um technician lê bot_token/api_key/client_secret/certificados no JSONB. Confirmar policy. `[banco: confirmar/ajustar]`
